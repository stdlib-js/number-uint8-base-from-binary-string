...
```javascript
fromBinaryStringUint8 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base-from-binary-string@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base-from-binary-string@v0.2.0-umd/browser.js"></script>
```
